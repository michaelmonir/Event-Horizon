...
class EventServiceTest {
    ...
    @Autowired
    private EventRepositoryService eventCreationRepository;
    @Autowired
    ...
    public void addEvent(){
        ...
        eventCreationRepository.saveEventWhenCreatingAndHandleAlreadyExisting(event);
    }
    @Test
    public void editEvent(){
        ...
        eventCreationRepository.updateEventAndHandleNotFound(24,event);
    }
    ...
    public void editEvent3(){
        ...
        Location location1= Location.builder().country("Egypt").city("cairo").build();
        Event event=Event.builder().eventAds(adsOption).eventLocation(location1).name("11").description("...").build();
        eventCreationRepository.updateEventAndHandleNotFound(30,event);
    }
    ...
    public void testGettingExceptionOnSendingIdWhenCreating()
    {
        ...
        try {
            this.eventCreationRepository.saveEventWhenCreatingAndHandleAlreadyExisting(event);
            Assertions.fail();
        }
