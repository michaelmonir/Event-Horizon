...
public class ProxyController {
    ...
    public ResponseEntity<AuthenticationResponse> basicSignUp(@RequestBody UserCreationDto registerRequest) {
    ...
    public ResponseEntity<AuthenticationResponse> signUpWithGmail(@RequestBody UserCreationDto registerRequest) {
        return new ResponseEntity<AuthenticationResponse>(proxyService.signUp(registerRequest), HttpStatus.OK);
    }
